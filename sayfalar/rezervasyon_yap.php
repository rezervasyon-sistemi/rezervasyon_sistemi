          ...
          <!-- /top tiles -->
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_panel">
						<div class="x_title"> 
						  <h5>Apart-1 İçin Uygun Rezervasyon Tarihleri</h5>
						  <div class="clearfix"></div>
						</div>
						<div class="x_content">
							<br/>
							...
							<form align="center" id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left">
								<div class="form-group">
									...
									<div class="col-md-4 col-sm-5 col-xs-12">
										<input type="text" class="form-control" required="required" readonly="readonly" value="21.06.2016" data-inputmask="'mask': '99.99.9999'">
								...
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-3 col-xs-12" for="last-name">Apart No <span class="required"></span></label>
									<div class="col-md-4 col-sm-6 col-xs-12">
